...
namespace UniversityWebApp.Gateway
{
    public class EnrollCourseGateway
    {
        ...
        public bool Check(EnrollCourse _enrollCourse)
        {
            ...
            command.CommandText = "SELECT * FROM EnrolledCourse WHERE StudentRegistrationId='" + _enrollCourse.StudentRegId + "' AND CourseId='" + _enrollCourse.CourseId + "'";
        ...
        public string SaveEnroll(EnrollCourse _enrollCourse)
        {
            ...
            cmd.CommandText = "INSERT INTO EnrolledCourse (StudentRegistrationId, CourseId, Date) VALUES ('" + _enrollCourse.StudentRegId + "','" + _enrollCourse.CourseId + "','"
            + _enrollCourse.Date + "')";
