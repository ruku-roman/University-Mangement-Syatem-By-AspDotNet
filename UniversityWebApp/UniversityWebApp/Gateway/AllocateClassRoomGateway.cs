...
namespace UniversityWebApp.Gateway
{
    public class AllocateClassRoomGateway
    {
        ...
        public bool Check(AllocateClassroom _allocateClassroom)
        {
            ...
            command.CommandText = "SELECT * FROM AllocateClassRooms WHERE RoomId='" + _allocateClassroom.RoomId + "' AND DaysId='" + _allocateClassroom.DaysId + "' AND StartId='" + _allocateClassroom.StartId + "'";
